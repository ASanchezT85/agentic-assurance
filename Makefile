...
test-console: ## What the Console renders, against a controlled platform (needs Node; no database)
	GOTMPDIR=$(CURDIR)/.gotmp go test -tags=console -count=1 -v -timeout 20m ./tests/console/...
